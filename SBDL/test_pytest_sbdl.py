...
def test_read_parties(spark, parties_list):
    ...
    assert_basic_rows_equality(expected_df.collect(), actual_df.collect())

def test_read_party_schema(spark, parties_list):
    expected_df = spark.createDataFrame(parties_list, DataLoader.get_party_schema())
    actual_df = DataLoader.read_parties(spark, "LOCAL", False, None)
...
def test_get_contract(spark, expected_contract_df):
    ...
    assert_basic_rows_equality(expected_contract_df.collect(), actual_contract_df.collect())
